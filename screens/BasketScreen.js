...
const BasketScreen = () => {
    ...
    useMemo(() => {
        // if the values of the item don't change, it won't recompute the value (computed property)
        const groupedItems = items.reduce((results, item) => {
            // loop through items in basket 
            // if the key of item.id exists then push item into that key 
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            <View className="flex-1 bg-gray-100">
                ...
                {/* divide-y trennt alle children elemente des scrollView mit einem border ab */}
